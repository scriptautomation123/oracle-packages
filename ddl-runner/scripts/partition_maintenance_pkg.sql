-- =====================================================
-- Oracle Partition Maintenance Package
...
CREATE TABLE partition_maintenance_jobs (
    ...
    CONSTRAINT chk_job_type CHECK (job_type IN ('CLEANUP', 'REBUILD_INDEXES', 'ANALYZE', 'COMPRESS', 'MOVE', 'SPLIT', 'MERGE')),
...
AS
    ...
    BEGIN
        IF p_partition_name IS NOT NULL THEN
            v_sql := 'ANALYZE TABLE ' || p_table_name || ' PARTITION(' || p_partition_name || ') COMPUTE STATISTICS';
        ELSE
        ...
        log_maintenance_operation('ANALYZE', p_table_name, NULL, 'SUCCESS', 
                                 'Partitions analyzed');
    EXCEPTION
        WHEN OTHERS THEN
            log_maintenance_operation('ANALYZE', p_table_name, NULL, 'ERROR', SQLERRM);
            RAISE;
