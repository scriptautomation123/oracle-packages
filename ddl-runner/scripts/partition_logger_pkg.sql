...
-- Create partition for log table (range partition by month)
ALTER TABLE partition_operation_log 
PARTITION BY RANGE (operation_time) (
    PARTITION p_log_2024_01 VALUES LESS THAN (TO_DATE('2024-02-01', 'YYYY-MM-DD')),
    PARTITION p_log_2024_02 VALUES LESS THAN (TO_DATE('2024-03-01', 'YYYY-MM-DD')),
    PARTITION p_log_2024_03 VALUES LESS THAN (TO_DATE('2024-04-01', 'YYYY-MM-DD')),
    PARTITION p_log_2024_04 VALUES LESS THAN (TO_DATE('2024-05-01', 'YYYY-MM-DD')),
    PARTITION p_log_2024_05 VALUES LESS THAN (TO_DATE('2024-06-01', 'YYYY-MM-DD')),
    PARTITION p_log_2024_06 VALUES LESS THAN (TO_DATE('2024-07-01', 'YYYY-MM-DD')),
    PARTITION p_log_2024_07 VALUES LESS THAN (TO_DATE('2024-08-01', 'YYYY-MM-DD')),
    PARTITION p_log_2024_08 VALUES LESS THAN (TO_DATE('2024-09-01', 'YYYY-MM-DD')),
    PARTITION p_log_2024_09 VALUES LESS THAN (TO_DATE('2024-10-01', 'YYYY-MM-DD')),
    PARTITION p_log_2024_10 VALUES LESS THAN (TO_DATE('2024-11-01', 'YYYY-MM-DD')),
    PARTITION p_log_2024_11 VALUES LESS THAN (TO_DATE('2024-12-01', 'YYYY-MM-DD')),
    PARTITION p_log_2024_12 VALUES LESS THAN (TO_DATE('2025-01-01', 'YYYY-MM-DD')),
